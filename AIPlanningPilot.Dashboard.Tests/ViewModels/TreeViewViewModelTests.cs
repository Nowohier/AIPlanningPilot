...
public class TreeViewViewModelTests
{
    ...
    public void TearDown()
    {
        ...
        _mockNavigationService.VerifyAll();
    }
    ...
    public void LoadTree_WhenDirectoryHasFiles_ShouldPopulateRootNodes()
    {
        ...
        _mockFileSystemService.Setup(fs => fs.GetDirectoryTree(rootPath, true))
            .Returns(
            [
        ...
        var viewModel = new TreeViewViewModel(_mockFileSystemService.Object, _mockConfigService.Object, _mockNavigationService.Object);
    ...
    public void Refresh_WhenCalled_ShouldReloadTree()
    {
        ...
        // First load: 1 file
        _mockFileSystemService.SetupSequence(fs => fs.GetDirectoryTree(rootPath, true))
    ...
    public void LoadTree_WhenFileNodeSelected_ShouldNavigateToFile()
    {
        ...
        _mockNavigationService.Setup(n => n.NavigateToFile(filePath));
        ...
        // Assert
        _mockNavigationService.Verify(n => n.NavigateToFile(filePath), Times.Once);
    }
    ...
    public void LoadTree_WhenDirectoryNodeSelected_ShouldNotNavigate()
    {
        ...
        _mockNavigationService.Verify(n => n.NavigateToFile(It.IsAny<string>()), Times.Never);
    }
    ...
    {
        // Arrange & Act
        var act = () => new TreeViewViewModel(null!, _mockConfigService.Object, _mockNavigationService.Object);
    ...
    {
        // Arrange & Act
        var act = () => new TreeViewViewModel(_mockFileSystemService.Object, null!, _mockNavigationService.Object);
    ...
    {
        // Arrange & Act
        var act = () => new TreeViewViewModel(_mockFileSystemService.Object, _mockConfigService.Object, null!);
